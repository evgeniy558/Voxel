...
- **Локально / симулятор:** в приложении в настройках можно оставить поле «URL API Spotify» пустым и указать в коде `spotifyToMp3APIBaseURL` (например `http://192.168.1.1:5001/api?url=`), либо ввести этот URL в настройках.
